package com.zentravel.vacation_web.service.Impl;
...
import com.zentravel.vacation_web.service.interfac.IUserService;
import com.zentravel.vacation_web.utils.JWTUtils;
import com.zentravel.vacation_web.utils.Utils;
...
public class UserService implements IUserService {
    ...
    public Response register(User user) {
        ...
        try {
            ...
            if (userRepository.existsByEmail(user.getEmail())) {
                throw new OurExceptions(user.getEmail() + "Already Exists");
            }
    ...
    public Response login(LoginRequest loginRequest) {
        ...
        try {
            ...
            var user = userRepository.findByEmail(loginRequest.getEmail()).orElseThrow(() -> new OurExceptions("user Not found"));
